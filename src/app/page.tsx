        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-xl text-gray-600">Stay informed about electoral developments</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-gradient-to-br from-white to-blue-50">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg leading-tight group-hover:text-blue-700 transition-colors">
                  Electoral Reforms Report Published
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-600 leading-relaxed">
                  Comprehensive report on proposed electoral reforms for enhanced democratic processes in Sri Lanka.
                </p>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-gradient-to-br from-white to-green-50">
              ...
              <CardContent className="space-y-4">
                <p className="text-gray-600 leading-relaxed">
                  Modern online voter registration system launched to improve accessibility and streamline processes.
                </p>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-gradient-to-br from-white to-orange-50">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg leading-tight group-hover:text-orange-700 transition-colors">
                  Election Spending Analysis
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-600 leading-relaxed">
                  Detailed analysis of 2024 presidential election spending reaches unprecedented transparency levels.
                </p>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-gradient-to-br from-white to-purple-50">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg leading-tight group-hover:text-purple-700 transition-colors">
                  Electoral Integrity Investigation
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-600 leading-relaxed">
                  Comprehensive investigation into reported electoral irregularities successfully concluded.
                </p>
